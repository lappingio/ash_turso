...
defmodule AshTurso.MigrationGenerator.Operation do
  @moduledoc false
  ...
  defmodule AddAttribute do
    ...
    def down(
      ...
      AshTurso.MigrationGenerator.Operation.RemoveAttribute.up(%{
        op
        | attribute: attribute,
          table: table,
          multitenancy: multitenancy
  ...
  defmodule AlterAttribute do
    ...
    def up(%{
      ...
      type_or_reference =
        if AshTurso.MigrationGenerator.has_reference?(multitenancy, attribute) and
  ...
  defmodule DropForeignKey do
    ...
    def up(%{table: table, attribute: %{references: reference}, direction: :up}) do
      ~s[raise "SQLite does not support dropping foreign key constraints. " <>
          ...
          "See https://www.techonthenet.com/turso/foreign_keys/drop.php for guidance."]
    end
  ...
  defmodule RemoveAttribute do
    ...
    def down(%{attribute: attribute, multitenancy: multitenancy, commented?: true}) do
      ...
      contents =
        %AshTurso.MigrationGenerator.Operation.AddAttribute{
          attribute: attribute,
          multitenancy: multitenancy
        }
        |> AshTurso.MigrationGenerator.Operation.AddAttribute.up()
        |> String.split("\n")
        |> Enum.map_join("\n", &"# #{&1}")
  ...
  defmodule AddCustomIndex do
    ...
    def down(%{index: index, table: table, multitenancy: multitenancy}) do
      index_name = AshTurso.CustomIndex.name(table, index)
