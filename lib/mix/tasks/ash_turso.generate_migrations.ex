...
defmodule Mix.Tasks.AshTurso.GenerateMigrations do
  @moduledoc """
  ...
  * `&DateTime.utc_now/0`
  ...
  2. Run `mix ash_turso.generate_migrations --dev` to generate dev migrations
  ...
  4. When ready, run `mix ash_turso.generate_migrations my_feature_name` to:
  ...
  def run(args) do
    ...
    domains = AshTurso.Mix.Helpers.domains!(opts, args)
    ...
    AshTurso.MigrationGenerator.generate(domains, opts)
  end
end
