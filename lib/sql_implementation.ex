...
defmodule AshTurso.SqlImplementation do
  @moduledoc false
  ...
  @impl true
  def manual_relationship_function, do: :ash_turso_join

  @impl true
  def manual_relationship_subquery_function, do: :ash_turso_subquery
  ...
  def expr(
      ...
      when like in [AshTurso.Functions.Like, AshTurso.Functions.ILike] do
    {arg1, acc} =
    ...
    inner_dyn =
      if like == AshTurso.Functions.Like do
  ...
  def table(resource) do
    AshTurso.DataLayer.Info.table(resource)
  end
  ...
  def repo(resource, kind) do
    AshTurso.DataLayer.Info.repo(resource, kind)
  end
