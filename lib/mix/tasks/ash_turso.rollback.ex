...
defmodule Mix.Tasks.AshTurso.Rollback do
  use Mix.Task

  import AshTurso.Mix.Helpers,
  ...
  ## Examples
      mix ash_turso.rollback
      mix ash_turso.rollback -r Custom.Repo
      mix ash_turso.rollback -n 3
      mix ash_turso.rollback --step 3
      mix ash_turso.rollback -v 20080906120000
      mix ash_turso.rollback --to 20080906120000
  ...
  def run(args) do
    ...
    repos = AshTurso.Mix.Helpers.repos!(opts, args)

    rest_opts =
      args
      |> AshTurso.Mix.Helpers.delete_arg("--domains")
      |> AshTurso.Mix.Helpers.delete_arg("--migrations-path")
